...
async function main() {
    console.log("🚀 Continuing Contract Deployment from Step 3...\n");
    ...
    try {
        ...
        console.log("📦 Step 3: Deploying FeeManager...");
        ...
        const registry = await ethers.getContractAt("Registry", contracts.Registry);
